...
<div class="example">
    <div class="container">
        <div class="row">
            ...
            <table class="table table-striped">
                ...
                <?php foreach ($product as $key) { ?>
                    <tr>
                        ...
                        <td><a href="Update_Product.php?id=<?php echo $key->getId() ?>">
                                <button>Update User</button>
                            </a>
                        </td>
                        <td><a href="delete.php?id=<?php echo $key->getId() ?>">
            ...
            <form action="Seach_Product.php" method="POST">
            ...
            <a href="index.php" style="margin-top: 500px"><button>Quay Lại</button></a>
        </div>
    </div>
